import Founder from '../../assets/founder-avatar.png';
...
const AboutView = () => {
  return (
    <>
      {' '}
      <h1 className="header__about">Vårt kaffe</h1>
      <div className="aboutpage__textsection">
        <p className="about_paragraph important">
